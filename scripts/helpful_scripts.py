...
LOCAL_BLOCKCHAIN_ENVIROMENTS = ["development","genache-local"]
...
def get_contract(contract_name):
    """This Function will grab the contract addresses from the brownie conifg if defined 
